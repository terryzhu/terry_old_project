...
BOOL CSkinScrollWnd::SkinWindow(CWnd *pWnd,HBITMAP hBmpScroll)
{
	...
	this->CreateEx(dwFrmStyleEx,AfxRegisterWndClass(NULL),TEXT("SkinScrollBarFrame"),dwFrmStyle,rcFrm,pParent,uID);

	//i make a change here
	m_wndLimit.Create(NULL,TEXT("LIMIT"),WS_CHILD|WS_VISIBLE,CRect(0,0,rcFrm.right-rcFrm.left,rcFrm.bottom-rcFrm.top),this,200);
